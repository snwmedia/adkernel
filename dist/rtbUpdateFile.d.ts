...
export declare class RtbUpdateFile {
    static updateFile(zoneRemoteFeedId: number, zoneRemoteObject: any, listName: string, appsId: Set<string>, jsonFileType: any, mode: Mode): Promise<string>;
    ...
    static updateList(token: string, listId: number, appListId: string, jsonName: string, apiType: string): Promise<string>;
    static createReferrerList(token: string, listName: string, fileId: string, jsonName: string, apiType: string): Promise<any>;
    static updateZoneRemoteFeed(token: string, ZoneRemoteFeedId: number, json: any): Promise<string>;
}
