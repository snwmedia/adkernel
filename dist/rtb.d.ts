export declare class RTB {
    ...
    static getAllAppBundlesByZoneRemoteFeed(from: Date, to: Date, zoneId: number, remoteFeedId: number, limit?: number): Promise<any[]>;
    ...
    static getAllSiteDomainsByZoneRemoteFeed(from: Date, to: Date, zoneId: number, remoteFeedId: number, limit?: number): Promise<any[]>;
    ...
    static getAllSspPublishersByZoneRemoteFeed(from: Date, to: Date, zoneId: number, remoteFeedId: number, limit?: number): Promise<any[]>;
}
